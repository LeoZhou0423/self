    ...
    <div className={`bauhaus-card overflow-hidden animate-fade-in-up ${className}`}>
      <div className="p-5 sm:p-6">
        ...
        <p className="mt-2 text-sm font-medium text-[var(--accent-blue)] sm:text-base lg:mt-3">
          <StreamingText text={archetype.portrait} speed={40} />
        </p>
      </div>
      ...
      <div className="border-t-2 border-[var(--border-color)] p-5 sm:p-6">
        ...
        {/* Details - appear after description finishes */}
        <div className={`mt-5 sm:mt-6 transition-all duration-500 ${showDetails ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          {/* Strengths */}
          <div>
