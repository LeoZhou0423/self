  ...
  return (
    <div className="bauhaus-card-sm overflow-hidden">
      ...
      >
        ...
        <ChevronDown
          size={20}
          className={`shrink-0 transition-transform duration-300 sm:size-6 ${open ? 'rotate-180' : ''}`}
        />
      </button>

      {open && (
        <div className="border-t-2 border-[var(--border-color)] p-4 animate-fade-in-up sm:p-5">
